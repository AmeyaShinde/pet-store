...
const EditProduct: React.FC = () => {
    ...
    return (
        <div className='edit-product'>
            <h2>Edit Product</h2>
            <TextField autoComplete='off' label="Brand" variant='outlined' name='brand' value={ product.brand } onChange={ changeHandler } />
            <TextField autoComplete='off' label="Title" variant='outlined' name='title' value={ product.title } onChange={ changeHandler } />
            <div>
